...
public class TestGrisaiaScene {
  ...
  public static void main(String[] args) {
     ...
     try {
       ...
       SpriteRegistry.registerSprite("Michiru", "FEyesClosed01", SpriteRegistry.FACE, "resx/img/sprites/Michiru/face-EyesClosed01.png");
       ...
       SpriteRegistry.registerSprite("Michiru", "FCringe", SpriteRegistry.FACE, "resx/img/sprites/Michiru/face-Cringe.png");
